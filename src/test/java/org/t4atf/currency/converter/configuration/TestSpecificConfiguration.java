...
public class TestSpecificConfiguration {
	...
	@Bean
	public MockRestServiceServer server() throws IOException, URISyntaxException {
		MockRestServiceServer server = MockRestServiceServer.createServer(restTemplate());
		server.expect(requestTo(ECBRateProvider.RATES_LOCATION)).andExpect(method(HttpMethod.GET))
